...
my @colors;
{
	...
	@colors = (
	'#FFFF00', '#4363d8', '#00894B', '#46f0f0', '#008941', '#008080', '#800000', '#A3005E', '#0000A6',
	'#e6194b', '#ffd8b1', '#fffac8', '#FF4A4E', '#00894C', '#FF4A4C', '#A3005E', '#aaffc3', '#0000AE',
	'#FFFF0A', '#000075', '#911eb4', '#FF4A4A', '#ffe119', '#9a6324', '#A3005A', '#7A490A', '#0000AA',
	'#FFFF0B', '#00894A', '#FF34FB', '#f032e6', '#f58231', '#3cb44b', '#A3005B', '#808000', '#0000AB',
	'#006FAB', '#1CE6FC', '#FF34FC', '#e6beff', '#bcf60c', '#fabebe', '#A3005C', '#7A490C', '#0000AC',
	);
}
